...
class TestMainKL(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.theory_kl_q_p = ((1 / 4) * np.log((1 / 4) / (7 / 25)) +
...
class TestDiscreteKL(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.known_p = generator.choice([0, 1, 2, 3], size=5000, replace=True,
                                       p=[7 / 25, 12 / 25, 4 / 25, 2 / 25])
        cls.known_p_rep = generator.choice([0, 1, 2, 3], size=5000, replace=True,
                                           p=[7 / 25, 12 / 25, 4 / 25, 2 / 25])
        cls.known_q = generator.choice([0, 1, 2, 3], size=5000, replace=True,
                                       p=[1 / 4, 1 / 4, 1 / 4, 1 / 4])
        cls.theory_kl_p_q = ((7 / 25) * np.log((7 / 25) / (1 / 4)) +
                             (12 / 25) * np.log((12 / 25) / (1 / 4)) +
                             (4 / 25) * np.log((4 / 25) / (1 / 4)) +
