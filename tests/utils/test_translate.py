...
# Local Imports
from metworkpy.utils.translate import (gene_to_reaction_dict, gene_to_reaction_df,
...
class TestListTranslate(unittest.TestCase):
    ...
    def test_reaction_to_gene(self):
        ...
        self.assertListEqual(reaction_to_gene_list(self.test_model, rxn_list),
                             gene_list_expected)
...
class TestDataFrameTranslate(unittest.TestCase):
    ...
    def test_reaction_to_gene(self):
        ...
        gene_df_calc = reaction_to_gene_df(self.test_model,
                                           rxn_df)
        self.assertListEqual(gene_df_calc["reactions"].to_list(),
                             rxn_df.index.to_list())
    ...
    def test_gene_to_reaction(self):
        ...
        rxn_df_calc = gene_to_reaction_df(
            self.test_model,
            gene_df
        )
        self.assertListEqual(rxn_df_calc["genes"].to_list(),
                             gene_df.index.to_list())
