...
class TestMainMI(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        norm_2d_0 = scipy.stats.multivariate_normal(mean=[0, 0], cov=[[1, 0], [0, 1]],
                                                    seed=314)
        norm_2d_0_3 = scipy.stats.multivariate_normal(mean=[0, 0],
                                                      cov=[[1, 0.3], [0.3, 1]],
                                                      seed=314)
        norm_2d_0_6 = scipy.stats.multivariate_normal(mean=[0, 0],
                                                      cov=[[1, 0.6], [0.6, 1]],
                                                      seed=314)
    ...
    def test_disc_cont(self):
        ...
        for p in [0.3, 0.5, 0.7]:
            ...
            mi_theory = -0.5 * (
                    (1 - p) * np.log(0.5 * (1 - p)) + p * np.log(0.5 * p) + np.log(
                0.5)) - np.log(2)

            for n_neighbors in [3, 5, 7]:
                mi_computed = mi.mutual_information(x=x, y=y, discrete_x=True,
                                                    discrete_y=False,
    ...
    def test_cont_cont_1d(self):
        mi_0 = mi.mutual_information(x=self.norm_2d_0_sample_1000[:, 0].reshape(-1, 1),
                                     ...
                                     n_neighbors=3, metric_x="cheb", metric_y="cheb")
        mi_0_3 = mi.mutual_information(
            x=self.norm_2d_0_3_sample_1000[:, 0].reshape(-1, 1),
            y=self.norm_2d_0_3_sample_1000[:, 1].reshape(-1, 1), n_neighbors=3,
            metric_x="cheb", metric_y="cheb")
        mi_0_6 = mi.mutual_information(
            x=self.norm_2d_0_6_sample_1000[:, 0].reshape(-1, 1),
            y=self.norm_2d_0_6_sample_1000[:, 1].reshape(-1, 1), n_neighbors=3,
            metric_x="cheb", metric_y="cheb")
    ...
    def test_cont_cont_2d(self):
        ...
        mi_2d_2d_0_3_0_6 = mi.mutual_information(
            ...
            y=self.norm_2d_2d_0_3_0_6_sample_1000[:, [2, 3]], discrete_x=False,
            discrete_y=False, n_neighbors=3, metric_x=np.inf, metric_y=np.inf)
        mi_2d_2d_0_3_0_6_cheb = mi._mi_cont_cont_cheb_only(
            x=self.norm_2d_2d_0_3_0_6_sample_1000[:, [0, 1]],
            y=self.norm_2d_2d_0_3_0_6_sample_1000[:, [2, 3]], n_neighbors=3)
        ...
        mi_2d_2d_0_3_0_6 = mi.mutual_information(
            x=self.norm_2d_2d_0_3_0_6_sample_1000[:, [0, 1]],
            y=self.norm_2d_2d_0_3_0_6_sample_1000[:, [2, 3]], discrete_x=False,
            discrete_y=False, n_neighbors=3, metric_x="euclidean", metric_y="cheby")
        mi_2d_2d_0_3_0_6_gen = mi._mi_cont_cont_gen(
            x=self.norm_2d_2d_0_3_0_6_sample_1000[:, [0, 1]],
            y=self.norm_2d_2d_0_3_0_6_sample_1000[:, [2, 3]], metric_x=2.,
            metric_y=np.inf, n_neighbors=3)
    ...
    def test_cont_cont_jitter(self):
        ...
        mi_2d_2d_0_3_0_6_jitter = mi.mutual_information(
            x=self.norm_2d_2d_0_3_0_6_sample_1000[:, [0, 1]],
            y=self.norm_2d_2d_0_3_0_6_sample_1000[:, [2, 3]], discrete_x=False,
            discrete_y=False, n_neighbors=3, jitter=1e-10, jitter_seed=314,
            metric_x="euclidean", metric_y="cheby")
        mi_2d_2d_0_3_0_6 = mi.mutual_information(
            x=self.norm_2d_2d_0_3_0_6_sample_1000[:, [0, 1]],
            y=self.norm_2d_2d_0_3_0_6_sample_1000[:, [2, 3]], discrete_x=False,
            discrete_y=False, n_neighbors=3, jitter=None, jitter_seed=314,
            metric_x="euclidean", metric_y="cheby")
        self.assertTrue(
...
class TestContCont(unittest.TestCase):
    ...
    def test_cont_cont_gen(self):
        mi_0 = mi._mi_cont_cont_gen(x=self.norm_2d_0_sample_1000[:, 0].reshape(-1, 1),
                                    y=self.norm_2d_0_sample_1000[:, 1].reshape(-1, 1),
                                    n_neighbors=3, metric_x=np.inf, metric_y=np.inf)
        mi_0_3 = mi._mi_cont_cont_gen(
            x=self.norm_2d_0_3_sample_1000[:, 0].reshape(-1, 1),
            y=self.norm_2d_0_3_sample_1000[:, 1].reshape(-1, 1), n_neighbors=3,
            metric_x=np.inf, metric_y=np.inf)
    ...
    def test_cont_cont_gen_non_scalar(self):
        ...
        _ = mi._mi_cont_cont_gen(x=self.norm_2d_2d_0_3_0_6_sample_1000[:, [0, 1]],
                                 ...
                                 n_neighbors=3, metric_x=2., metric_y=2.)

    def test_cont_cont_cheb_only(self):
        mi_0 = mi._mi_cont_cont_cheb_only(
            x=self.norm_2d_0_sample_1000[:, 0].reshape(-1, 1),
            y=self.norm_2d_0_sample_1000[:, 1].reshape(-1, 1), n_neighbors=1)
        mi_0_3 = mi._mi_cont_cont_cheb_only(
            x=self.norm_2d_0_3_sample_1000[:, 0].reshape(-1, 1),
            y=self.norm_2d_0_3_sample_1000[:, 1].reshape(-1, 1), n_neighbors=1)
        mi_0_6 = mi._mi_cont_cont_cheb_only(
            x=self.norm_2d_0_6_sample_1000[:, 0].reshape(-1, 1),
            y=self.norm_2d_0_6_sample_1000[:, 1].reshape(-1, 1), n_neighbors=1)
        self.assertTrue(np.isclose(mi_0, self.norm_2d_0_mi, atol=0.08))
        self.assertTrue(np.isclose(mi_0_3, self.norm_2d_0_3_mi, atol=0.05))
        self.assertTrue(np.isclose(mi_0_6, self.norm_2d_0_6_mi, atol=0.05))
...
class TestDiscCont(unittest.TestCase):
    def test_mi_disc_cont(self):
        ...
        for p in [0.3, 0.5, 0.7]:
            ...
            for n_neighbors in [3, 5, 7]:
                mi_computed = mi._mi_disc_cont(discrete=x.reshape(-1, 1),
                                               continuous=y.reshape(-1, 1),
                                               n_neighbors=n_neighbors)
                self.assertTrue(np.isclose(mi_computed, mi_theory,
                                           rtol=1e-1))  # TODO: Add tests based on the studies from the paper (3 square waves, and 3 Gaussians)
...
class TestDiscDisc(unittest.TestCase):
    ...
    def test_mi_disc_disc(self):
        ...
        self.assertAlmostEqual(mi._mi_disc_disc(x=x, y=y),
                               I_xy)  # TODO: Add more edge cases
...
class TestHelperFunctions(unittest.TestCase):
    ...
    def test_jitter_single(self):
        ...
        arr_jittered = metworkpy.utils._jitter._jitter_single(arr_test, jitter=1e-10,
                                                              generator=generator)
    ...
    def test_jitter(self):
        ...
        arr1_jit, arr2_jit = metworkpy.utils._jitter._jitter(arr1, arr2,
                                                             jitter=(1e-9, 1e-10),
                                                             jitter_seed=42,
                                                             discrete_x=False,
                                                             discrete_y=False)
